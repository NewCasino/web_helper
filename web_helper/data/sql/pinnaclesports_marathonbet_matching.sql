...
where  a.id in  (select max(id) from europe_100 where  start_time>'2014-10-13 00:00:00' group by website,start_time,host,client)
and    b.id in  (select max(id) from europe_100 where  start_time>'2014-10-13 00:00:00' group by website,start_time,host,client)
...
(
	...
	from  europe_100_log 
	where f_start_time>'2014-10-13 00:00:00'  and timespan >'2014-10-13 00:00:00' and website='pinnaclesports'
) a
union all
select count(*) from
(
	select distinct website,start_time,host,client,odd_win,odd_draw,odd_lose
	from  europe_100_log 
	where f_start_time>'2014-10-13 00:00:00' and timespan >'2014-10-13 00:00:00' and website='marathonbet'
) b
