...
where  a.id in  (select max(id) from europe_100 where start_time>'2014-10-12 00:00:00' group by website,start_time,host,client)
and    b.id in  (select max(id) from europe_100 where start_time>'2014-10-12 00:00:00' group by website,start_time,host,client)
