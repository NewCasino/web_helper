    ...
    public partial class frm_match_compute_method_analyse : Form
    {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                for (int j = i + 1; j < dt.Rows.Count; j++)
                {
                    for (int count = start_count; count <= end_count; count++)
                    {
                        ...
                        BsonDocument doc_fix_bid = MatchComputeMethod.get_doc_two_fix_bid(match1, match2, count);
                        BsonDocument doc_group = MatchComputeMethod.get_doc_two_into_group(doc_fix_bid);
                        this.txt_compute.Text = this.txt_compute.Text + Environment.NewLine + Environment.NewLine +
                                                "-------------------------------------------------------------------------------" + Environment.NewLine +
                                                MatchComputeMethod.get_info_from_doc(doc_fix_bid) + Environment.NewLine + Environment.NewLine + MatchComputeMethod.get_info_from_doc(doc_group);
                ...
                for (int j = i + 1; j < dt.Rows.Count; j++)
                {
                    for (int count = start_count; count <= end_count; count++)
                    {
                        ...
                        for (int more = 1; more <= 100; more++)
                        {
                            ...
                            BsonDocument doc_fix_bid_next = MatchComputeMethod.get_doc_two_fix_bid_with_last_doc(doc_temp, match1, match2, count);
                            doc_temp = doc_fix_bid_next;

                            this.txt_compute.Text = this.txt_compute.Text + Environment.NewLine + Environment.NewLine +
                                                    "-------------------------------------------------------------------------------" + Environment.NewLine +
                                                    MatchComputeMethod.get_info_from_doc(doc_fix_bid_next) + Environment.NewLine;
                            Application.DoEvents();
                        }
                    }
        ...
        private void btn_compute_range_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                for (int j = i + 1; j < dt.Rows.Count; j++)
                {
                    ...
                    BsonDocument doc_range = MatchComputeMethod.get_doc_two_add_range(match1, match2, range_min, range_max);
                    BsonDocument doc_group = MatchComputeMethod.get_doc_two_into_group(doc_range);
                    this.txt_compute.Text = this.txt_compute.Text + Environment.NewLine + Environment.NewLine +
                                            "-------------------------------------------------------------------------------" + Environment.NewLine +
                                            MatchComputeMethod.get_info_from_doc(doc_range) + Environment.NewLine + Environment.NewLine + MatchComputeMethod.get_info_from_doc(doc_group);
                    Application.DoEvents();
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                for (int j = i + 1; j < dt.Rows.Count; j++)
                {
                    ...
                    step_next:
                        ...
                        sb.Append("------------------------------------------------------------------------------------------------" + Environment.NewLine);
                        sb.Append(dt.Rows[i]["start_time"].ToString() + "      " + dt.Rows[i]["host"].PR(10) + dt.Rows[i]["client"].PR(10));
                        sb.Append(three1.PR(10) + one1.PR(10) + zero1.PR(10) + Environment.NewLine);
                        sb.Append(dt.Rows[j]["start_time"].ToString() + "      " + dt.Rows[j]["host"].PR(10) + dt.Rows[j]["client"].PR(10));
                        sb.Append(three2.PR(10) + one2.PR(10) + zero2.PR(10) + Environment.NewLine);
                        ...
                        sb.Append(steps[0].PR(10) + steps[1].PR(10) + steps[2].PR(10) +
                                steps[3].PR(10) + steps[4].PR(10) + steps[5].PR(10) +
                                steps[6].PR(10) + steps[7].PR(10) + steps[8].PR(10) + Environment.NewLine);
                        sb.Append(bids[0].PR(10) + bids[1].PR(10) + bids[2].PR(10) +
                           bids[3].PR(10) + bids[4].PR(10) + bids[5].PR(10) +
                           bids[6].PR(10) + bids[7].PR(10) + bids[8].PR(10) + Environment.NewLine);
        ...
        private void btn_compute_circle_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                for (int j = i + 1; j < dt.Rows.Count; j++)
                {
                    ...
                    for (int k=1;k<=100;k++)
                    {
                        BsonDocument doc = MatchComputeMethod.get_doc_two_like_circle(match1, match2,k);

                        sb.Append("------------------------------------------------------------------------------------------------" + Environment.NewLine);
                        sb.Append(MatchComputeMethod.get_info_from_doc(doc));
                        this.txt_compute.Text = sb.ToString();
                        Application.DoEvents();
                    }
        ...
        private void btn_compute_circle_one_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                    ...
                    for (int k = 1; k <= 100; k++)
                    {
                        BsonDocument doc = MatchComputeMethod.get_doc_one_like_circle(match1,k);
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                for (int j = i + 1; j < dt.Rows.Count; j++)
                {
                    ...
                    for (int k = j + 1; k < dt.Rows.Count; k++)
                    {
                        ...
                        for (int l = 1; l <= 100; l++)
                        {
                            BsonDocument doc = MatchComputeMethod.get_doc_three_like_circle(match1, match2, match3, l);
